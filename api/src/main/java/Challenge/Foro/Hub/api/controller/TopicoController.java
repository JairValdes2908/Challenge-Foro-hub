...
import Challenge.Foro.Hub.api.domain.topicos.*;
import Challenge.Foro.Hub.api.domain.topicos.dto.*;
import Challenge.Foro.Hub.api.domain.topicos.validaciones.ValidadorService;
...
public class TopicoController {
    ...
    @Operation(
            ...
            description = "Registrar topico no existente en base a su titulo y/o mensaje. " +
                    "La respuesta el topico registrado con su respectivo id, titulo, mensaje, status, autor, nombreCurso y fecha"
    )
    @PostMapping
    @Transactional
